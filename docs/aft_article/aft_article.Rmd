...
In a broader context, one can observe two major trends in computational folkloristics whose convergence will be underlying the results of the next decade. The first is focus on the evolutionary aspect of motif and/or tale type distributions, either with regard to certain tale types \cite{silva_comparative_2016}, \cite{karsdorp_topic_2013}, \cite{karsdorp_retelling_2016} (eg d’Huy and Tehrani), or geographical distribution of globally occurring narrative motifs \cite{thuillard_large-scale_2018}. Strikingly, there is a certain genetically inspired thinking in the background, ultimately going back to the modeling capacities inherent in Dawkins' meme theory \cite{dawkins_selfish}, comparing tale types as motif sequences to 'narrative DNA'\cite{daranyi_toward_2012}, \cite{ofek_linking_2013}, \cite{meder_automatic_2016} (Murphy 2014, 2015), or looking at the evolution of narrative/story networks as a quasi-biological process based on the mutation and recombination of narrative elements \cite{karsdorp_retelling_2016}. Such views possibly rely on certain similarities with bioinformatics in terms of network motif identification (ref), a problem analog with ours. 
