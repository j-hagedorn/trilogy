...
Big folklore collections anticipated by \cite{tangherlini_trawling_2013} and \cite{tangherlini_bigfolk} are still missing. Based on \cite{meder_dutch_2010} and \cite{ilyefalvi_theoretical_2018}, the largest databases seem to be the Dutch Folktale Database of the Meertens Institute, and the Danish Folklore Archive’s Tang Kristensen Collection, the former in the magnitude of around 50.000 texts, the latter at around 35.000 texts \cite{tangherlini_trawling_2013}. Other important databases in Estonia, Russia \cite{berezkin_peopling_2017} etc. exist, but are either beyond public access, in their original languages only, or both. The notable exception is the Meertens Institute whose texts are of course in Dutch and Frisian plus a number of local dialects, but can be read in English translation as well. Typically, authors who work with these databases extract their research datasets but do not make them public for any number of reasons \cite{karsdorp_topic_2013}, \cite{karsdorp_retelling_2016}.

Other researchers who have shared their data as supporting material for their articles include e.g. \cite{tehrani_oral_2016}, \cite{silva_comparative_2016}, \cite{tehrani_riding_2013} and \cite{bortolini_inferring_2017}. Also, \cite{declerck_linked_2017} and \cite{declerck_ontologies_2017} report that recently, a large amount of ATU data have been made available online by the Multilingual Folk Tale Database (*www.mftd.org*), offering also annotation facilities for tales in multilingual versions. A step in the right direction as it sounds, as this paper goes to press, we have no information about the conditions of their usability yet.

The best example we have been looking for was \cite{lo_exploring_2020} who have published their dataset on Github as well (https://github.com/GossaLo/afr-neural-folktales/ ). Another fine candidate for such a dataset was Prof D.L. Ashliman’s Folktexts Collection whose conversion  to the desired format will be described below. Importantly, Prof. Ashliman graciously agreed to donate his collection to the digital humanities (DH) and data science research communities.
