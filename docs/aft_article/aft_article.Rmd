...
```{r fig.cap="Example output of the dataset"}
aft %>%
...
```{r word_hist, fig.cap="Distribution of tale lengths", fig.asp = 0.36}
...
```{r type_hist, fig.cap="Distribution of tale type membership size", fig.asp = 0.36}
