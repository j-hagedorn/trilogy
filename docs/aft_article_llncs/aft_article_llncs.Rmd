...
## Global options
# https://www.youtube.com/watch?v=xxpMU7TPHtQ
library(knitr)
...
The current version of the `aft` dataset is located on the `trilogy` GitHub repository.  
...
This functionality allows for the corpus to serve as a communal resource, and we welcome inquiries and suggestions about how best to manage this resource as a "commons" \cite{vollan_cooperation_2010}.
...
```{r typehist, fig.cap="Distribution of tale type membership size", fig.asp = 0.36}
...
We thank Professor D.L. Ashliman for his permission to use the data from his annotated Folktexts as a publicly available resource.
